...
const About = () => {
    ...
    return (
        <div data-scroll data-scroll-speed="-.2" className='w-full min-h-screen bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl'>
            ...
            <div>
                ...
                mt-[1.5vw] ml-11 '>
                    ...
                    <div className='rounded-2xl'>
                        <img className='object-cover bg-center rounded-2xl h-[65vh] mr-[1vw] mb-[3vw]' src="https://ochi.design/wp-content/uploads/2022/05/Homepage-Photo-663x469.jpg" alt="" />
                    </div>
                  </div>
